...
if { ${design_name} eq "" } {
   ...
   if { $cur_design ne $design_name } {
      common::send_msg_id "BD_TCL-2001" "INFO" "Changing value of <design_name> from <$design_name> to <$cur_design> since current design is empty."
      set design_name [get_property NAME $cur_design]
   }
   common::send_msg_id "BD_TCL-2002" "INFO" "Constructing design in IPI design <$cur_design>..."
   ...
   common::send_msg_id "BD_TCL-2003" "INFO" "Currently there is no design <$design_name> in project, so creating one..."

   create_bd_design $design_name

   common::send_msg_id "BD_TCL-2004" "INFO" "Making design <$design_name> as current_bd_design."
   current_bd_design $design_name

}

common::send_msg_id "BD_TCL-2005" "INFO" "Currently the variable <design_name> is equal to \"$design_name\"."

if { $nRet != 0 } {
   catch {common::send_msg_id "BD_TCL-2006" "ERROR" $errMsg}
   return $nRet
}
...
"
   ...
   common::send_msg_id "BD_TCL-2011" "INFO" "Checking if the following IPs exist in the project's IP catalog: $list_check_ips ."
   ...
   if { $list_ips_missing ne "" } {
      catch {common::send_msg_id "BD_TCL-2012" "ERROR" "The following IPs are not found in the IP Catalog:\n  $list_ips_missing\n\nResolution: Please add the repository containing the IP(s) to the project." }
...
"
   ...
   common::send_msg_id "BD_TCL-2020" "INFO" "Checking if the following modules exist in the project's sources: $list_check_mods ."
   ...
   if { $list_mods_missing ne "" } {
      catch {common::send_msg_id "BD_TCL-2021" "ERROR" "The following module(s) are not found in the project: $list_mods_missing" }
      common::send_msg_id "BD_TCL-2022" "INFO" "Please add source files for the missing module(s) above."
      set bCheckIPsPassed 0
   }
}

if { $bCheckIPsPassed != 1 } {
  common::send_msg_id "BD_TCL-2023" "WARNING" "Will not continue with creation of design due to the error(s) above."
  return 3
}
...
proc create_hier_cell_hier_slowddr { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-2092" "ERROR" "create_hier_cell_hier_slowddr() - Empty argument(s)!"}
     return
  }
  ...
  if { $parentObj == "" } {
     catch {common::send_msg_id "BD_TCL-2090" "ERROR" "Unable to find parent cell <$parentCell>!"}
     return
  }
  ...
  if { $parentType ne "hier" } {
     catch {common::send_msg_id "BD_TCL-2091" "ERROR" "Parent <$parentObj> has TYPE = <$parentType>. Expected to be <hier>."}
     return
  }
...
proc create_hier_cell_hier_uart { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-2092" "ERROR" "create_hier_cell_hier_uart() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_hier_prm_peripheral { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-2092" "ERROR" "create_hier_cell_hier_prm_peripheral() - Empty argument(s)!"}
     return
  }
  ...
  if { [catch {set axi_jtag_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     ...
     catch {common::send_msg_id "BD_TCL-2096" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
proc create_hier_cell_hier_pardcore_peripheral { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-2092" "ERROR" "create_hier_cell_hier_pardcore_peripheral() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_hier_clkrst { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-2092" "ERROR" "create_hier_cell_hier_clkrst() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {##########################################UART 0#UART 0##SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#############Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins hier_pardcore_peripheral/M00_AXI] [get_bd_intf_pins hier_uart/S00_AXI]
  connect_bd_intf_net -intf_net S_AXIS_S2MM_1 [get_bd_intf_pins hier_pardcore_peripheral/S_AXIS_S2MM] [get_bd_intf_pins hier_prm_peripheral/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_ports S_AXI_MEM] [get_bd_intf_pins hier_prm_peripheral/S_AXI_MEM]
  connect_bd_intf_net -intf_net S_AXI_MMIO_1 [get_bd_intf_ports S_AXI_MMIO] [get_bd_intf_pins hier_pardcore_peripheral/S_AXI_MMIO]
  ...
  connect_bd_intf_net -intf_net hier_dma_M_AXIS_MM2S [get_bd_intf_pins hier_pardcore_peripheral/M_AXIS_MM2S] [get_bd_intf_pins hier_prm_peripheral/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net hier_pardcore_peripheral_M_AXI_DMA [get_bd_intf_ports M_AXI_DMA] [get_bd_intf_pins hier_pardcore_peripheral/M_AXI_DMA]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports pardcore_coreclk] [get_bd_ports pardcore_uncoreclk] [get_bd_pins hier_clkrst/pardcore_uncoreclk] [get_bd_pins hier_pardcore_peripheral/s_axi_lite_aclk] [get_bd_pins hier_prm_peripheral/pardcore_uncoreclk] [get_bd_pins hier_uart/pardcore_coreclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net hier_dma_mm2s_introut1 [get_bd_ports mm2s_introut] [get_bd_pins hier_pardcore_peripheral/mm2s_introut1] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net hier_dma_s2mm_introut1 [get_bd_ports s2mm_introut] [get_bd_pins hier_pardcore_peripheral/s2mm_introut1] [get_bd_pins xlconcat_1/In3]
  ...
  connect_bd_net -net pardcore_uncorerst_interconnect_aresetn [get_bd_pins hier_clkrst/interconnect_aresetn1] [get_bd_pins hier_pardcore_peripheral/S00_ARESETN] [get_bd_pins hier_prm_peripheral/S00_ARESETN] [get_bd_pins hier_uart/aresetn]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins hier_clkrst/interconnect_aresetn] [get_bd_pins hier_pardcore_peripheral/aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins hier_clkrst/peripheral_aresetn] [get_bd_pins hier_pardcore_peripheral/axi_resetn1]
...
common::send_msg_id "BD_TCL-2053" "WARNING" "This Tcl script was generated from a block design that has not been validated. It is possible that design <$design_name> may result in errors during validation."
